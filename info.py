...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('AUTH_CHANNEL', '-1002273359017 -1002468720216 -1002456676056').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
